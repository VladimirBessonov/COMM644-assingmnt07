...
const handlerStep3 = () => {
    let name = prompt('Enter you Name');
    let surname = prompt('Enter you Name');
...
//STEP 6
const handlerStep6 = () => {
    let sentence = prompt('enter you sentence or leave default', 'The quick brown fox jumped over the lazy dog');
    let searchWord = prompt('enter your name or leave default', 'monkey');
    if (sentence !== 'The quick brown fox jumped over the lazy dog') {
        let replacement = prompt('what you want to replace in the entered sentence?');
...
const handlerStep8 = () => {
    ...
    let new_string = old_string.slice();
